...
##Need "grant select on mysql.* to zabbix_agent@localhost identified by 'zabbix_agent'"
#Mysql5.6
# mysql_config_editor set --login-path=local --host=localhost --user=zabbix_agent -p
MYSQL_SOCK="/tmp/mysql.sock" 
MYSQL_PWD="zabbix_agent"
